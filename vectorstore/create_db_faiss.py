...
def load_folder_as_doc(folder=r"C:\Users\cengh\Desktop\PlanC\vectorstore\pdf_files\icra_sorunlari_cozum_onerileri.pdf", extension='pdf'):
    loader = PyPDFLoader(r"C:\Users\cengh\Desktop\PlanC\vectorstore\pdf_files\ilovepdf_merged_merged.pdf")
...
if __name__ == '__main__':
    ...
    # Usage:
    # python lib_faiss.py --f pdf_files -e openai -v faiss_index_openai  # Requires OPEN_API_KEY
